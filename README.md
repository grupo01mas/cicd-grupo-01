...
* **Blue/Green:** escopo não incluído nesta entrega — `cd-blue-green.yml` e `cd-blue-green-switch.yml` permanecem como esqueletos em `.yml.example`
